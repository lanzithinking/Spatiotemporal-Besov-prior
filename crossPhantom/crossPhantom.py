#!/usr/bin/env python
"""
Class definition of the dynamic linear inverse problem of crossPhantom.
Shiwei Lan @ ASU 2022
--------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    # test
    xph.test(1e-8, MF_only=False)
    # obtain MAP
    map_v = xph.get_MAP(SAVE=True, NCG=True)#,init_opt='LSE',lmda=10)
