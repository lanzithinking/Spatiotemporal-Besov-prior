...
cd ~/Projects/STBP/code/crossPhantom

# run python script
python -u crossPhantom.py #> crossPhantom-MAP.log &
# sbatch --job-name=crossPhantom --output=crossPhantom.log getMAP_crossPhantom.sh