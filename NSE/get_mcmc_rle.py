...
if os.path.exists(os.path.join(folder,'rle_summary.npz')):
    ...
    for m in range(num_mdls):
        ...
        nse = STEMPO(**data_args, spat_args=spat_args, temp_args=temp_args, store_eig=store_eig, seed=seed)
        nse.misfit.nzcov = sps.eye(nse.misfit.nzcov.shape[0], format='csr')
