...
def main(seed=2022):
    ...
    try:
        ...
        u=stpo.init_parameter if hasattr(stpo,'init_parameter') else stpo._init_param()
    ...
    if med_f is not None:
        stpo.misfit.plot_reconstruction(rcstr_imgs=med_f, save_imgs=True, save_path='./reconstruction/ESS_median')
    stpo.misfit.plot_reconstruction(rcstr_imgs=mean_f, save_imgs=True, save_path='./reconstruction/ESS_mean')
    stpo.misfit.plot_reconstruction(rcstr_imgs=std_f, save_imgs=True, save_path='./reconstruction/ESS_std')
