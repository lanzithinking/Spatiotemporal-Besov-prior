"""
Utility functions for the crossPhantom dataset.
"""
...
def generate_crossPhantom(noise_level):

    get_crossPhantom_data()
...
if __name__ == "__main__":
    ...
    (A, b, AA, B, nx, ny, nt, delta) = generate_crossPhantom(0)
    ...
    for i in range(xx.shape[2]):
        plt.imshow(xx[:,:,i])
        plt.savefig('./reconstruction_anisoTV/crossPhantom_'+str(i)+'.png',bbox_inches='tight')
        # plt.show()
