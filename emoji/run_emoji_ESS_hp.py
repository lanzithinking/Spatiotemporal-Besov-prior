...
def main(seed=2022):
    ...
    if pre_optim:
        ...
        # emj.prior.mean=u # center the prior
    ...
    for i in range(args.num_samp+args.num_burnin):
        if i==pre_optim_steps and pre_optim:
            ...
            beginning=timeit.default_timer()
            # emj.prior.mean=u # re-center the prior
        ...
        u_=u-(0 if emj.prior.mean is None else emj.prior.mean)
    ...
    filename='emj_ESS_hp_dim'+str(len(u))+'_'+ctime
    ...
    emj.misfit.plot_reconstruction(rcstr_imgs=mean_f, save_imgs=True, save_path='./reconstruction/ESS_hp_mean')
    emj.misfit.plot_reconstruction(rcstr_imgs=std_f, save_imgs=True, save_path='./reconstruction/ESS_hp_std')
